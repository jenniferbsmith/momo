      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-background/95 to-background/90 relative overflow-hidden">
        ...
        <section className="container mx-auto px-4 py-20 text-center relative">
          ...
          >
            ...
            >
              Professional AI-powered editor trusted by 50,000+ creators for creating breathtaking text-behind-image designs. 
              Our advanced machine learning algorithms ensure pixel-perfect results - no layers, no manual masking required.
            </motion.p>
